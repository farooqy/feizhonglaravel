...
<head>
    ...
    <title>AtoC - Terms and Conditions</title>
    ...
    <div class="container" style="color: black">
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <p>These terms and conditions outline the rules and regulations for the use of AtoC's applications,
                    located at
                    <ol>
                        <li>
                            <a href="https://atoc.drongo.tech">https://atoc.drongo.tech</a>
                        </li>
                        <li>
                            <a href="https://atocchina.com">
                                https://atocchina.com
                            </a>
                        </li>
                        <li>
                            <a href="https://atocafrica.com">
                                https://atocafrica.com
                            </a>
                        </li>
                        <li>
                            <a href="">
                                AtoC mobile applications
                            </a>
                        </li>
                    </ol>
                </p>
                ...
                <p>We employ the use of cookies. By accessing AtoC, you agreed to use cookies in agreement with the
                    AtoC's
                    Privacy
                    Policy. </p>
                ...
                <p>Unless otherwise stated, AtoC and/or its licensors own the intellectual property rights for all
                    material on
                    AtoC. All
                    intellectual property rights are reserved. You may access this from AtoC for your own personal use
                    subjected
                    to
                ...
                <p>You must not:</p>
                <ol>
                    <li>Republish material from AtoC</li>
                    <li>Sell, rent or sub-license material from AtoC</li>
                    <li>Reproduce, duplicate or copy material from AtoC</li>
                    <li>Redistribute content from AtoC</li>
                </ol>

                <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of
                    the <a href="https://www.termsandconditionsgenerator.com">Terms And Conditions Generator</a> and the
                ...
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain
                    areas
                    of the website. AtoC does not filter, edit, publish or review Comments prior to their presence on
                    the
                    website.
                    Comments do not reflect the views and opinions of AtoC,its agents and/or affiliates. Comments
                    reflect the
                    views and
                ...
                <p>AtoC reserves the right to monitor all Comments and to remove any Comments which can be considered
                    inappropriate,
                ...
                <p>You hereby grant AtoC a non-exclusive license to use, reproduce, edit and authorize others to use,
                    reproduce
                    and edit
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    negative
                    records
                    with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of AtoC;
                    and (d)
                    the
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website,
                    you
                    must inform us by sending an e-mail to AtoC. Please include your name, your organization name,
                    contact
                    information
                    as well as the URL of your site, a list of any URLs from which you intend to link to our Website,
                    and a list
                    of the
                ...
                <p>No use of AtoC's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
                ...
                <p>We shall not be hold responsible for any content that appears on your Website. You agree to protect
                    ...
                    be
                    interpreted
                    as libelous, obscene or criminal, or which infringes, otherwise violates, or advocates the
                    infringement or
                    other
                ...
                <p>
                    We strive to ensure the information on these applications to be correct and authentic to our
                    customers and
                    companies,
                    however, we do understand and acknowledge the occurance of innacurate information and in the event
                    you come
                    across
                    such information, you can inform as anytime and we will take actions to correct and validate the
                    information. However we
                    are not obliged to do so if we deem it different than your view.
                </p>
