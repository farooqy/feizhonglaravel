                    ...
                    <table class="custom-table">
                        ...
                        <tbody v-for="(need, key ) in user_needs">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" @click.prevent="getNeedMatches(need.id,need.need_token)">
                                        Get Companies
                                    </a>
                                </td>
                            </tr>
...
<div class="">
    ...
    <userneeds v-bind="needs_modal" v-if="needs_modal.visible" v-on:close-user-need-modal="closeNeedsModal()">
    </userneeds>
</div>
@endsection
